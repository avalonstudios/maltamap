...
if ( ! function_exists( 'maltamap_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function maltamap_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'maltamap' ),
...
if ( ! function_exists( 'maltamap_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function maltamap_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'maltamap_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function maltamap_entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'maltamap' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'maltamap' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'maltamap_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function maltamap_post_thumbnail() {
